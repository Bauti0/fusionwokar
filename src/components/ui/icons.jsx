...
// Símbolo oficial de Mercado Pago (path oficial de la marca, color azul
// marcario #00B1EA). Solo la insignia/iso, sin el wordmark.
export function IconMercadoPago(props) {
  return (
    <svg viewBox="0 0 24 24" fill="#00B1EA" role="img" aria-label="Mercado Pago" {...props}>
